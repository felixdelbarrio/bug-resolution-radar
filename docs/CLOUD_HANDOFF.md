...
El contrato v2 contiene exclusivamente:
...
`semanticContract: "desktop-authoritative-v1"` y expone:
...
- vistas ya materializadas de overview, insights, tendencias, incidencias y kanban;
- hechos verificables para Gemini y la newsletter;
...
6. WebApp, enlace compartido y newsletter leen el snapshot activo. La newsletter usa
   sus hechos inmutables, enlaza Google Slides y adjunta el PPTX original.
...
selección de página, orden de filas, elección de gráfico o cambio de sección. No se
...
No se mantiene retrocompatibilidad con el traslado v1. Cualquier cambio de forma
...
- adjunto canónico en la newsletter y sintaxis válida de Apps Script.
