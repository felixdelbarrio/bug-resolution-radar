...
2. La colección se deduplica por país y `Owner Support Company`; no se particiona por origen Jira porque las mismas INC pueden aparecer en varios orígenes del país.
