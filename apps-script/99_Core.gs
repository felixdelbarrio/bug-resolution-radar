...
function _publicError_(err) {
  ...
  const safeCodes = ['FORBIDDEN', 'CONTRACT_ERROR', 'VALIDATION_ERROR', 'INVALID_URL', 'INVALID_KEY', 'NOT_FOUND', 'LOCK_TIMEOUT', 'UPLOAD_EXPIRED', 'SECRET_FIELD_REJECTED', 'TRANSFER_INVALID', 'TRANSFER_TOO_LARGE', 'TRANSFER_STAGING_FAILED', 'DRIVE_FOLDER_INVALID', 'REPORT_GENERATION_FAILED', 'APP_URL_INVALID', 'SHARE_INVALID', 'SNAPSHOT_NOT_FOUND', 'SNAPSHOT_CORRUPT', 'VIEW_NOT_MATERIALIZED', 'READ_ONLY_SNAPSHOT', 'NEWSLETTER_VALIDATION_FAILED', 'NEWSLETTER_STALE', 'NEWSLETTER_NO_RECIPIENTS', 'NEWSLETTER_SEND_FAILED', 'NEWSLETTER_IN_PROGRESS', 'NEWSLETTER_ALREADY_SENT', 'NEWSLETTER_TEST_REQUIRED', 'NEWSLETTER_SENDER_UNAVAILABLE'];
